...
rootpath = r"D:\New folder\New folder\ZOOM\New folder\Sounds"
pattern = "*.mp3"
...
listbox = tk.Listbox(canvas, fg = "purple", bg = "dark gray", width = 100, font = ('Rockwell', 15))
listbox.pack(padx = 15, pady = 15) 

label = tk.Label(canvas, text = '', bg = 'black', fg = 'green', font = ('ds-digital', 15))
label.pack(pady = 15)
